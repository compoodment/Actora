...
from game_setup import (
    generate_startup_actor_id as _generate_startup_actor_id,
    setup_initial_world_from_character as _setup_initial_world_from_character,
)
...
def generate_startup_actor_id(role, *, id_source=None):
    ...
    return _generate_startup_actor_id(role, id_source=id_source)
...
def setup_initial_world_from_character(
    ...
    *,
    ...
    """Compatibility delegate to the curses-free startup boundary."""
    return _setup_initial_world_from_character(
        character_data,
...
def setup_initial_world(
    ...
    *,
    ...
    return setup_initial_world_from_character(
        default_character_data,
        random_source=random_source,
        id_source=id_source,
    )
